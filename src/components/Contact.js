    ...
    >
      <div className="container py-24 mx-auto flex sm:flex-no-wrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-6 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded-lg">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full p-8 mt-8 md:mt-0 rounded-lg shadow-2xl">
          ...
          <button
            className="text-white bg-indigo-700 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded-lg text-lg"
